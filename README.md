...
**Missão dos Foguetes** é um jogo educativo desenvolvido para auxiliar crianças no desenvolvimento do raciocínio lógico e da resolução de problemas de forma divertida.

O jogo é composto por **5 fases**, nas quais o jogador deve abastecer um foguete escolhendo a quantidade correta de galões de combustível para completar cada missão.
